...
const MainPage = () => {
    return ( 
        <div>
            <div className="box-main w-full bg-gray-50 py-12">
            ...
            <div className="container-boxes flex justify-between flex-wrap mt-5">
                <div className="w-1/2 h-52 p-1">
                ...
                <div className="w-full pt-10">
                    ...
                    <div className="article pt-5">
                        <div className="w-full boxes rounded p-3"><h2>فرانت اند چیه ؟</h2></div>
                        <div className="w-full boxes rounded p-3 mt-2"><h2>چرا ری اکت ؟</h2></div>
                        <div className="w-full boxes rounded p-3 mt-2"><h2>ورود به دنیای برنامه نویسی</h2></div>
                        <div className="w-full boxes rounded p-3 mt-2"><h2>چگونه برنامه نویس بهتری شویم ؟</h2></div>
                        <div className="w-full boxes rounded p-3 mt-2"><h2>sass چیست ؟</h2></div>
                        <div className="w-full boxes rounded p-3 mt-2"><h2>flex چیست ؟</h2></div>
                        <div className="w-full boxes rounded p-3 mt-2"><h2>grid چیست ؟</h2></div>
                    </div>
                </div>
