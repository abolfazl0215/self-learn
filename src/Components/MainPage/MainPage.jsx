...
const MainPage = () => {
    return ( 
        <div>
            <div className="box-main w-full bg-gray-50 py-12 sm:grid grid-cols-4">
                <img src="image/illustration.png" alt="" className="w-72 mx-auto sm:col-span-2 w-96"/>
            ...
            <div className="container-boxes flex justify-between flex-wrap mt-5 lg:justify-evenly">
                ...
                <div className="42 h-52 p-1 lg:w-1/5 lg:m-4">
                    <div className="w-full h-full rounded pt-5 boxes">
                ...
                <div className="w-full pt-10">
                    ...
                    <div className="article pt-5 ">
                        <div className="w-full boxes rounded p-3 lg:text-center  mx-auto m-3"><h2>فرانت اند چیه ؟</h2></div>
                        <div className="w-full boxes rounded p-3 mt-2 lg:text-center  mx-auto m-3"><h2>چرا ری اکت ؟</h2></div>
                        <div className="w-full boxes rounded p-3 mt-2 lg:text-center  mx-auto m-3"><h2>ورود به دنیای برنامه نویسی</h2></div>
                        <div className="w-full boxes rounded p-3 mt-2 lg:text-center  mx-auto m-3"><h2>چگونه برنامه نویس بهتری شویم ؟</h2></div>
                        <div className="w-full boxes rounded p-3 mt-2 lg:text-center  mx-auto m-3"><h2>sass چیست ؟</h2></div>
                        <div className="w-full boxes rounded p-3 mt-2 lg:text-center  mx-auto m-3"><h2>flex چیست ؟</h2></div>
                        <div className="w-full boxes rounded p-3 mt-2 lg:text-center  mx-auto m-3"><h2>grid چیست ؟</h2></div>
                    </div>
                </div>
